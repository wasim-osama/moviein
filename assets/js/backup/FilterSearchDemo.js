...
function pagination(){
    ...
    let pageLi = 1;
    if(currentPage >= 6){
        html += `<li class="page-item"><a onclick="goToPage(1)" class="page-link bg-dark text-light border-accents px-4 py-2" role="button">1</a></li>`;
        html += `<li class="page-item"><a onclick="goToPage(2)" class="page-link bg-dark text-light border-accents px-4 py-2" role="button">2</a></li>`;
    ...
    if((currentPage - 2) > 0){
        pageLi++;
        html += `<li class="page-item"><a onclick="goToPage(`+(currentPage - 2)+`)" class="page-link bg-dark text-light border-accents px-4 py-2 cursor" role="button">`+(currentPage - 2)+`</a></li>`;
    }
    if((currentPage - 1) > 0){
        pageLi++;
        html += `<li class="page-item"><a onclick="goToPage(`+(currentPage - 3)+`)" class="page-link bg-dark text-light border-accents px-4 py-2 cursor" role="button">`+(currentPage - 1)+`</a></li>`;
    }
    html += `<li class="page-item"><a onclick="goToPage(`+currentPage+`)" class="page-link bg-success text-dark border-accents px-4 py-2 cursor" role="button">`+currentPage+`</a></li>`;
    if((currentPage + 1) <= totalPage){
        pageLi++;
        html += `<li class="page-item"><a onclick="goToPage(`+(currentPage + 1)+`)" class="page-link bg-dark text-light border-accents px-4 py-2 cursor" role="button">`+(currentPage + 1)+`</a></li>`;
    }
    ...
    for (let i = reqPageStart; i <reqPage; i++){
        html += `<li class="page-item"><a onclick="goToPage(`+i+`)" class="page-link bg-dark text-light border-accents px-4 py-2 cursor" role="button">`+i+`</a></li>`;
    }
    console.log(pageLi)
